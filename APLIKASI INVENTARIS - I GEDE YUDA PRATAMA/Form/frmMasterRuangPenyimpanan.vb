Public Class frmMasterRuangPenyimpanan
    ...
    Sub Databaru()
        ...
        txtKodeRuang.Text = ExecuteAutoCode("ruang_penyimpanan", "KodeRuang", "RPN", "000000")
        TampilTabel()
    ...
    Sub Simpan()
        ...
        If StatusDataBaru = True Then
            ...
            If Cari.Length <= 0 Then
                'INSERT
                ExecuteQuery("INSERT INTO ruang_penyimpanan(KodeRuang,NamaRuang,Keterangan) VALUES ('" & txtKodeRuang.Text & "','" & txtNamaRuang.Text & "','" & txtKeterangan.Text & "')")
                Databaru()
        ...
        Else
            'UPDATE
            ExecuteQuery("UPDATE ruang_penyimpanan SET NamaRuang='" & txtNamaRuang.Text & "', Keterangan='" & txtKeterangan.Text & "' WHERE KodeRuang='" & txtKodeRuang.Text & "'")
            Databaru()
            MessageBox.Show("Data Berhasil Disimpan!", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Sub
    ...
    Sub Hapus()
        If GridView1.RowCount > 0 Then
            If MessageBox.Show("Data Akan Dihapus! Lanjutkan?", "Validasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                'DELETE
                ExecuteQuery("DELETE FROM ruang_penyimpanan WHERE KodeRuang='" & GridView1.GetFocusedRowCellValue("KodeRuang") & "'")
                Databaru()
    ...
    Private Sub frmMasterRuangPenyimpanan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.KeyPreview = True
