        ...
        Try
            ...
            If CariPengguna.Length > 0 Then
                ...
                If CariPengguna(0).Item("Password") = txtPassword.Text Then
                    ...
                    If CariPengguna(0).Item("KodePengguna") = "PNG000000" Then
                        'jika yang login pengguna dengan kode PNG0000000
                        'isi data login ke my.settings
                        My.Settings.lgnKodePengguna = CariPengguna(0).Item("KodePengguna")
                        My.Settings.lgnNamaPengguna = CariPengguna(0).Item("NamaPengguna")
                        My.Settings.lgnKodePengguna = "ADMINISTRATOR"
                    ...
                    Else
                        ...
                        Dim CariHakAkses = ExecuteQuery("select * from hak_akses where NamaHakAkses='" & CariPengguna(0).Item("NamaHakAkses") & "'").Select()
                        ...
                        If CariHakAkses.Length > 0 Then
                            ...
                            CariHakAkses(0).Item("NilaiHakAkses"))
                            'isi data login ke my.settings
                            My.Settings.lgnKodePengguna = CariPengguna(0).Item("KodePengguna")
                            My.Settings.lgnNamaPengguna = CariPengguna(0).Item("NamaPengguna")
                            My.Settings.lgnNamaHakAkses = CariPengguna(0).Item("NamaHakAkses")
                            'tampilkan menu utama
                            frmSetupMenuUtama.Show()
                            'tutup form login
                            Me.Close()
